    ...
    <section id="toppart">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark">
        <a class="navbar-brand" href="#">
          <?php echo "<img src='img/uddy.png' alt='' width='30' height='24' class='d-inline-block align-top imgtop' >";
           ?>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#myservices">MY SKILLS & SERVICES</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#recentprojects">PORTFOLIO</a>
          </li>
          <li class="nav-item">
...
echo "<h3 class='h2ii' id='aboutme'> ABOUT ME</h3>";
...
<section id="toppart">
  ...
  echo "<br>";
   ...
   <?php
   echo "<h3 class='h3iii' id='myservices'> MY SERVICES </h3>";
    ?>
...
<?php
echo "<h3 class='h2ii' id='recentprojects' > MY RECENT PROJECTS </h3>";
 ?>
...
<?php
echo "<h3 id='testimonials'> TESTIMONIALS </h3>";
 ?>
...
<section>
  ...
  <?php
  echo "<h3 class='h2ii' id='contactme'>CONTACT ME </h3>";
   ?>
...
<section id="toppart">
  ...
  echo "<br>";
   ...
   <?php
echo "<h6> © 2022 Akpainyang Udeme Mfonobong {Uddy} | All Rights Reserved </h6>";
    ?>
